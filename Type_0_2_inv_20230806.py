...
BTC_0_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-BTC', 'ma_duration_long': 68, 'ma_duration_mid': 35, 'ma_duration_short': 3, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0001, 'successive_rise': 6, 'ratio_ema_mid_long': 0.99,              'ref_vol_duration': 4, 'diff_m_l_factor': 0.005, 'coe_vol_comp': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.003, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}
...
ETC_5_dic = {'type': 'type_2', 'coin_No': 5, 'coin_Name': 'KRW-ETC', 'ma_duration_long': 102, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8,              'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 30, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 20, 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 32, 'ma_duration_short': 50, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 5, 'ratio_ema_mid_long': 0.985, 'ratio_vol_curr_prior': 1.0,               'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.8, 'ratio_peak_diff': 0.014, 'interm_sell_duration': 5, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 14, 'coin_Name': 'KRW-ARK', 'ma_duration_long': 91, 'ma_duration_mid': 27, 'ma_duration_short': 63, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 40, 'recent_vol_duration': 12, 'sell_method_vol_cri': 0.6, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 999, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 57, 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 104, 'ma_duration_mid': 23, 'ma_duration_short': 67, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99,                'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 37, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 5, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 9, 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 77, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 10, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 39, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.4, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

BCH_30_dic = {'type': 'type_2', 'coin_No': 30, 'coin_Name': 'KRW-BCH', 'ma_duration_long': 103, 'ma_duration_mid': 30, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 49, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.7, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 6, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 72, 'coin_Name': 'KRW-BORA', 'ma_duration_long': 101, 'ma_duration_mid': 35, 'ma_duration_short': 61, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 11, 'ratio_ema_mid_long': 0.99,                'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 5, 'recent_vol_duration': 7, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.007, 'interm_sell_duration': 3, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

EOS_22_dic = {'type': 'type_2', 'coin_No': 22, 'coin_Name': 'KRW-EOS', 'ma_duration_long': 98, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 6, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 10, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.003, 'interm_sell_duration': 99, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0}

#SSX_84_dic = {'type': 'type_2', 'coin_No': 84, 'coin_Name': 'KRW-SSX', 'ma_duration_long': 99, 'ma_duration_mid': 33, 'ma_duration_short': 80, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, \
#              'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 47, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.008, 'interm_sell_duration': 4, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}


# In[9]:


LIST_target = [BTC_0_dic, ETH_1_dic, WAVES_7_dic, STEEM_11_dic, XRP_4_dic, HIVE_67_dic, ETC_5_dic, BTG_20_dic, ARK_14_dic, WAXP_57_dic, QTUM_9_dic, BCH_30_dic, BORA_72_dic, EOS_22_dic]
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        if (DF_check_peak['volume'][-2] < (target_dic['sell_method_vol_cri'] * DF_check_peak.iloc[(-5) : -2]['volume'].mean())) and         (time_elapse_bought > 1) and ((DF_check_peak.loc[DF_check_peak.iloc[-time_elapse_bought : ]['ratio_ema_long'].idxmax()]['ratio_ema_long'] - DF_check_peak['ratio_ema_long'][-1]) > target_dic['ratio_peak_diff']) :
...
def type_2_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        elif (DF_check_peak['open'][-1] < target_dic['bought_price']) and         (DF_check_peak.iloc[-(target_dic['interm_sell_duration'] + 1) : -1]['volume'].mean() < (1.0 * DF_check_peak.iloc[-(time_elapse +1) : -1]['volume'].mean())) and         (DF_check_peak.iloc[-target_dic['interm_sell_duration'] : ]['bought_rise_fall'].sum() < time_auto_interm_sell_duration) and         ((DF_check_peak['open'][-1] / DF_check_peak['open'][-target_dic['interm_sell_duration']]) < (1 - (0.6 * target_dic['ratio_sell_forced']))) :
